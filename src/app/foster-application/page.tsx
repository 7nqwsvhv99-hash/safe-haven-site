...
export default function FosterApplicationPage() {
  ...
  return <div className="bg-slate-50">
    <section className="hero-gradient"><div className="container-custom section-padding max-w-3xl text-center space-y-4"><h1 className="text-4xl md:text-5xl font-bold">Foster Application</h1><p className="text-lg text-muted-foreground">Tell us about your household and the types of cat or dog foster placements you could support. Additional questions appear only for the foster situations you select.</p></div></section>
