...
export default async function WebsiteContentManagementPage(){
  ...
  return <main className="min-h-screen bg-slate-50"><div className="container-custom py-10 md:py-12">
    ...
    <section className="mb-8 grid gap-4 sm:grid-cols-3">{[
      ["Upcoming events",upcoming.length,CalendarDays],["Published events",publishedEvents.length,Megaphone],["Published stories",publishedStories.length,Quote]
    ...
    <div className="space-y-8">
      ...
      <form action={createEvent} className={`h-fit rounded-2xl bg-slate-50 p-5 md:p-6 ${events.length ? "" : "mx-auto max-w-5xl"}`}>
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <label className="block text-sm font-medium">Event type<select name="eventType" defaultValue="Other" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5">{["Fundraiser","Adoption Event","Community Event","Volunteer Event","Clinic","Other"].map(x=><option key={x}>{x}</option>)}</select></label>

          <label className="block text-sm font-medium">Start date & time<input name="start" type="datetime-local" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label>
          <label className="block text-sm font-medium">End date & time<input name="end" type="datetime-local" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label>
          ...
          <label className="block text-sm font-medium sm:col-span-2">Short description<textarea name="shortDescription" rows={2} className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label>
          <label className="block text-sm font-medium sm:col-span-2">Full description<textarea name="fullDescription" rows={4} className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label>

          <label className="block text-sm font-medium">Button label<input name="ctaLabel" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label>
          <label className="block text-sm font-medium">Button URL<input name="ctaUrl" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label>
          <label className="block text-sm font-medium">Registration / ticket URL<input name="registrationUrl" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label>
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm sm:col-span-2">
            <label><input name="allDay" type="checkbox" className="mr-2"/>All day</label>
