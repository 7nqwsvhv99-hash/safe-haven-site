  ...
  return <main className="min-h-screen bg-slate-50"><div className="container-custom py-10 md:py-12">
    ...
    <div className="space-y-8">
      ...
      <section className="rounded-3xl border bg-white p-6 shadow-sm md:p-8">
        <h2 className="text-2xl font-bold">Real Families. Real Second Chances.</h2>
        <p className="mt-2 text-sm text-muted-foreground">Add an approved adoption story for the website.</p>

        <form action={createTestimonial} className="mt-5 max-w-3xl space-y-4 rounded-2xl bg-slate-50 p-5 md:p-6">
