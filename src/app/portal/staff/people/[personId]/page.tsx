...
export default async function PersonProfilePage({params}:{params:Promise<{personId:string}>}){
  ...
  const [
    ...
    airtableList(TABLES.contactLog,["Person","Date / Time","Contact Method","Direction","Subject / Summary","Notes","Completed By","Next Follow-Up Date"],{sort:[{field:"Date / Time",direction:"desc"}]}),
  ...
  async function addContact(formData:FormData){
    ...
    await airtableCreate(TABLES.contactLog,{
      ...
      ...(field(formData,"nextFollowUp")?{"Next Follow-Up Date":field(formData,"nextFollowUp")}:{ }),
    },true);
    revalidatePath("/portal/staff/people/"+personId);revalidatePath("/portal/staff/people");
  }
