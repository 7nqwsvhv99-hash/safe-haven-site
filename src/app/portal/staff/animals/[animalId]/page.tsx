    ...
    <main className="min-h-screen bg-slate-50">
      <div className="container-custom py-10 md:py-12">
        ...
        <section id="adoption" className="mb-8 rounded-3xl border bg-white p-6 shadow-sm md:p-8">
          <div className="mb-5 flex items-center gap-3"><UserRoundCheck className="h-6 w-6 text-primary" /><div><h2 className="text-2xl font-bold">Adoption</h2><p className="text-sm text-muted-foreground">Applications and completed adoption records tied to this animal.</p></div></div>
