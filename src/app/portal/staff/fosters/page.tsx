                  ...
                  <details key={record.id} className="rounded-2xl border p-5">
                    ...
                    <div className="mt-5 grid gap-5 border-t pt-5 lg:grid-cols-2">
                      ...
                      <form action={updateApplication} className="space-y-4 rounded-2xl bg-slate-50 p-5">
                        ...
                        <div className="grid gap-3 sm:grid-cols-2"><label className="block text-sm font-medium">Next follow-up<input name="nextFollowUp" type="date" defaultValue={asText(record.fields["Next Follow-Up Date"]).slice(0,10)} className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label><label className="block text-sm font-medium">Decision date<input name="decisionDate" type="date" defaultValue={asText(record.fields["Decision Date"]).slice(0,10)} className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label></div>
                    ...
                    <details key={placement.id} className="rounded-2xl border p-5">
                      ...
                      <div className="mt-5 grid gap-5 border-t pt-5 lg:grid-cols-2">
                        ...
                        <form action={addStaffCheckIn} className="space-y-3 rounded-2xl bg-slate-50 p-5">
                          ...
                          <label className="block text-sm font-medium">Appetite<select name="appetite" defaultValue="Not Applicable" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5">{["Normal","Reduced","Not Eating","Increased","Variable","Not Applicable"].map((value)=><option key={value}>{value}</option>)}</select></label>
                          <label className="block text-sm font-medium">Behavior<textarea name="behavior" rows={2} className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label>
                          <label className="block text-sm font-medium">Medication / treatment<textarea name="medication" rows={2} className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label>
                          ...
                          <div className="grid gap-3 sm:grid-cols-2"><label className="block text-sm font-medium">Priority<select name="priority" defaultValue="Normal" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5">{["Normal","High","Urgent"].map((value)=><option key={value}>{value}</option>)}</select></label><label className="block text-sm font-medium">Next check-in<input name="nextCheckInDate" type="date" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5"/></label></div>
          ...
          <div className="space-y-6">
            <section className="rounded-3xl border bg-white p-6 shadow-sm md:p-8">
              ...
              <form action={createPlacement} className="space-y-4">
                ...
                <label className="block text-sm font-medium">Placement status<select name="placementStatus" defaultValue="Active" className="mt-2 w-full rounded-xl border bg-white px-3 py-2.5">{["Planned","Active"].map((value)=><option key={value}>{value}</option>)}</select></label>
                <div className="grid gap-3 sm:grid-cols-2"><label className="block text-sm font-medium">Start date<input name="startDate" type="date" defaultValue={todayChicago()} className="mt-2 w-full rounded-xl border px-3 py-2.5"/></label><label className="block text-sm font-medium">Expected end date<input name="expectedEndDate" type="date" className="mt-2 w-full rounded-xl border px-3 py-2.5"/></label></div>
                <label className="block text-sm font-medium">Next check-in<input name="nextCheckInDate" type="date" className="mt-2 w-full rounded-xl border px-3 py-2.5"/></label>
                <label className="block text-sm font-medium">Care instructions<textarea name="careInstructions" rows={4} className="mt-2 w-full rounded-xl border px-3 py-2.5"/></label>
