          ...
          <div className="space-y-6">
            <section className="rounded-3xl border bg-white p-6 shadow-sm md:p-8">
              ...
              <form action={completeAdoption} className="space-y-4">
                ...
                <label className="block text-sm font-medium">Placement notes<textarea name="placementNotes" rows={3} className="mt-2 w-full rounded-xl border px-3 py-2.5"/></label>
                <label className="flex items-start gap-3 rounded-xl bg-slate-50 p-4 text-sm"><input name="microchipTransferred" type="checkbox" className="mt-1"/><span><strong>Microchip registration transferred to adopter</strong><span className="mt-1 block text-muted-foreground">Check only after the transfer has actually been completed.</span></span></label>
