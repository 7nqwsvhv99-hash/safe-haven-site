...
export default function FosterPage() {
  return (
    <div className="flex flex-col">
      ...
      <section id="apply" className="section-padding bg-primary/5"><div className="container-custom max-w-2xl text-center"><h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Foster?</h2><p className="text-lg text-muted-foreground mb-8">Tell us about your household and the types of foster placements you could support. The application will show additional questions only for the animals and foster situations you select.</p><Button asChild size="lg"><Link href="/foster-application">Start Foster Application</Link></Button><p className="text-sm text-muted-foreground mt-4">Questions? Call us at (815) 858-2265.</p></div></section>
    </div>
  )
}
